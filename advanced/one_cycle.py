...
class OneCycle(object):
    ...
    Args:
        ...
        div             The division factor used to get lower boundary of learning rate. This
                        ...
                        The default value is 10.
    """
    def __init__(self, optimizer, nb, momentum_vals=(0.95, 0.85), prcnt= 10, div=10):

        self.optimizer = optimizer
        self.nb = nb
        self.div = div
        self.step_len =  int(self.nb * (1- prcnt/100)/2)
        self.high_lr = np.asarray([g['lr'] for g in self.optimizer.param_groups])
    ...
    def _update_lr(self, lr):
        for g, l in zip(self.optimizer.param_groups, lr):
            g['lr'] = l
